...
<div class="flex flex-col w-full h-full items-center justify-center">
    ...
    <Robo />
    <div class="container bg-white shadow flex flex-col sm:max-w-screen-sm px-6 py-6 pb-10 items-center rounded-lg">
        <form class="w-full" on:submit={ e => {
            ...
            <label for="email" class="mb-3 ml-1 block text-base font-medium text-gray-700 mt-8">Email address</label>
            <div class="relative flex items-center mt-1">
                ...
                <input type="email" bind:value={email} class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 focus:border-indigo-400 focus:ring-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address">
            </div>            
            <div class="mt-6">
